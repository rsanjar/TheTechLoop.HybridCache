...
public static class CacheServiceCollectionExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddTheTechLoopCache(IConfiguration configuration,
        ...
        /// </summary>
        public IServiceCollection AddTheTechLoopMultiLevelCache(IConfiguration configuration,
            string configSectionName = ConfigSection)
        {
            var config = configuration.GetSection(configSectionName).Get<CacheConfig>() ?? new CacheConfig();
        ...
        /// </summary>
        public IServiceCollection AddTheTechLoopCacheWarmup()
        {
